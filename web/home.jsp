    ...
    <div class="container">
        ...
        <section class="product" id="products">
            ...
            <div class="listProduct">
                <div class="item">
                    <img src="./image/product/sofa.png" alt="Sofa">
                ...
                <div class="item">
                    <img src="./image/product/microwaveoven.png" alt="">
                    <h4 class="item-name">NAME PRODUCT</h4>
                    <div class="price">$200</div>
                    <form>
                        <div class="value-button" id="decrease"><span>-</span></div>
                ...
                <div class="item">
                    <img src="./image/product/bed.png" alt="">
                    <h4 class="item-name">NAME PRODUCT</h4>
                    <div class="price">$200</div>
                    <form>
                        <div class="value-button" id="decrease"><span>-</span></div>
                ...
                <div class="item">
                    <img src="./image/product/tv.png" alt="">
                    <h4 class="item-name">NAME PRODUCT</h4>
                    <div class="price">$200</div>
                    <form>
                        <div class="value-button" id="decrease"><span>-</span></div>
                ...
                <div class="item">
                    <img src="./image/product/dishwasher.png" alt="">
                    <h4 class="item-name">NAME PRODUCT</h4>
                    <div class="price">$200</div>
                    <form>
                        <div class="value-button" id="decrease"><span>-</span></div>
                ...
                <div class="item">
                    <img src="./image/product/fridge.png" alt="">
                    <h4 class="item-name">NAME PRODUCT</h4>
                    <div class="price">$200</div>
                    <form>
                        <div class="value-button" id="decrease"><span>-</span></div>
                ...
                <div class="item">
                    <img src="./image/product/toilet.png" alt="">
                    <h4 class="item-name">NAME PRODUCT</h4>
                    <div class="price">$200</div>
                    <form>
                        <div class="value-button" id="decrease"><span>-</span></div>
                ...
                <div class="item">
                    <img src="./image/product/washingmachine.png" alt="">
                    <h4 class="item-name">NAME PRODUCT</h4>
                    <div class="price">$200</div>
                    <form>
                        <div class="value-button" id="decrease"><span>-</span></div>
